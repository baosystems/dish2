...
Dish is configured through a *dish.json* configuration file which must be a valid JSON object. Note that the protocol (e.g. "http://") is required for the base URL. Example configuration:
